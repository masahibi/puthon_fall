...
class Box:
    ...
    def check_wall(self):  # 壁の判定関数
        ...
        if self.ball.x <= self.west or self.ball.x + self.ball.d >= self.east:  # もし左か右壁に当たったら
            self.ball.vx = -self.ball.vx  # 反射させる
